...
window.__YSFDASWITCH__ = 1;
window.__YSFDAROOT__ = "/images/kefu/da.gif";
window.__YSFISGA__ = 0; !
function() {
    function execEvent(e, t) {
        var n = ysf[e];
        if (util.isFunction(n)) if (inited) return n.apply(null, t);
        else switch (e) {
        case "onready":
        case "onLayerload":
        case "onunread":
    ...
    var recordVisitorLeave = function(e) {
        ...
        if (e) c();
        else if (util.isMobilePlatform) util.addEvent(window, "pagehide",
        function() {
            c()
        });
        else util.addEvent(window, "beforeunload",
        function() {
            c()
        })
    };
    ...
    var getUnread = function() {
        ...
        if (!cache.noUnreadPolling) if (!document.hidden) util.ajax({
        ...
        return function() {
            ...
            if (e) {
                ...
                if (document.getElementById("YSF-PANEL-MOBILE")) {
                    ...
                    document.getElementById("YSF-PANEL-MOBILE").addEventListener("touchmove",
                    function(e) {
                        e.stopPropagation()
                    })
                }
    ...
    ysf.on = function() {
        ...
        return function(e) {
            ...
            if (/object/gi.test(t)) {
                for (var n in e) if ("onload" == n && util.isFunction(e[n])) if (!inited) util.addLoadEventForProxy(e[n]);
                else e[n]();
                else if ("onLayerload" == n && util.isFunction(e[n])) if ("loaded" == ysf.openInline.loadStatus) e[n]();
                else ysf["_" + n] = e[n];
    ...
    ysf.clearDragresize = function(e) {
        try {
            ...
            else for (var o = 0; o < n.length; o++) util.clearLocalItems(util.findLocalItems(new RegExp(t + "-" + n[o], "ig")))
        } catch(i) {}
    };
...
var __YSFOPTION__ = {
    ...
    hidden: 0,
    preloadIframe: 1,
    appKey: '9ef44920e8f31e03515f88d30abcb52d'
};
__YSFOPTION__.uid = '';
try {
